...
bike_df = read.csv("C:/Users/rsk29/Documents/UT/Summer/Machine Learning/R files/Bike rentals/Bike_rental_data.csv")
...
bike_val = bike_df_enc[ii[n1+1:n2+n1],]
bike_test = bike_df_enc[ii[n1+n2+1:n3+n2+n1],]
...
cat("The optimal tree size = ", iitree, "/n")
cat("The cp value that gives the optimal trees = ", cpvec[iitree] , "/n")
cat("Out of sample Loss value = ", oltree[iitree] , "/n")
...
for(i in 1:nset) {
  cat('doing boost ',i,' out of ',nset,'/n')
